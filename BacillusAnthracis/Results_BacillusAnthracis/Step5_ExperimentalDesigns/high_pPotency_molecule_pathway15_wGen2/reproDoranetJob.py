...
jobName      = "high_pPotency_molecule_pathway15_wGen2"
starters     = {'C=CC[C@H]1C(=O)OC(=CCNC(N)=[NH2+])C1=O'}
helpers      = {'S', '[H][H]', '[C-]#[O+]', 'O=S(O)O', 'O=NO', 'C=O', 'N', 'O', 'O=C=O', 'O=S=O', 'O=S(=O)(O)O', 'O=O', '[Br][Br]', 'CO', 'N#CO', 'C=C', 'Br', 'N#N', 'O=[N+]([O-])O', 'C#N', 'NO'}
