...
jobName      = "high_pPotency_molecule_pathway5_wGen1"
starters     = {'Nc1cc(O)cc(C=C2C=C(O)C(=O)O2)c1'}
helpers      = {'O=C=O', 'O=S=O', '[Br][Br]', 'O=[N+]([O-])O', 'Br', 'O=S(O)O', 'CO', '[H][H]', 'C#N', 'NO', 'N#N', 'O=NO', 'C=C', 'C=O', '[C-]#[O+]', 'N', 'O', 'N#CO', 'S', 'O=S(=O)(O)O', 'O=O'}
target       = {'NC(=O)c1cc(N)cc(C=C2C=C(O)C(=O)O2)c1'}
maxAtoms     = {'C': 17, 'N': 2, 'O': 6, 'S': 1}
generations  = 1
ruleset      = "JN3604IMT"
searchDepth  = 1
maxNumRxns   = 1
