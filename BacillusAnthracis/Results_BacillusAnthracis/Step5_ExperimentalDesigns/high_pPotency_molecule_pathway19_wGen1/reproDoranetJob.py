...
jobName      = "high_pPotency_molecule_pathway19_wGen1"
starters     = {'CC[C@@H]1C(=O)OC(=CCNC(N)=[NH2+])C1=O'}
helpers      = {'[C-]#[O+]', 'O', 'S', '[Br][Br]', 'O=NO', 'O=C=O', 'O=O', 'N#N', 'C=O', 'NO', '[H][H]', 'O=S(O)O', 'C=C', 'O=S=O', 'CO', 'Br', 'N#CO', 'C#N', 'O=S(=O)(O)O', 'N', 'O=[N+]([O-])O'}
target       = {'C[C@]1(CC(=O)O)C(=O)OC(=CCNC(N)=[NH2+])C1=O'}
maxAtoms     = {'C': 14, 'N': 5, 'O': 5, 'S': 1}
generations  = 1
ruleset      = "JN3604IMT"
searchDepth  = 1
maxNumRxns   = 1
