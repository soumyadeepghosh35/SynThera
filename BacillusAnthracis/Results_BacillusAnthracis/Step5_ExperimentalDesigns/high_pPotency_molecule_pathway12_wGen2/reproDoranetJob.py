...
jobName      = "high_pPotency_molecule_pathway12_wGen2"
starters     = {'C=CC[C@H]1CC(=CCNC(N)=[NH2+])OC1=O'}
helpers      = {'O=NO', 'O=S(=O)(O)O', 'O=S(O)O', 'Br', 'C#N', 'C=O', 'N#CO', 'C=C', '[Br][Br]', 'O=C=O', 'N#N', 'N', 'O=O', 'O', 'CO', '[C-]#[O+]', '[H][H]', 'O=[N+]([O-])O', 'S', 'O=S=O', 'NO'}
target       = {'C=CC1C(=CCNC(N)=[NH2+])OC(=O)[C@H]1CCCO'}
