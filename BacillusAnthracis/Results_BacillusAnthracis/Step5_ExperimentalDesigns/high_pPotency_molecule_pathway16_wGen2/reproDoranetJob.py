...
starters     = {'C=CC[C@@H]1C(=O)OC(=CCNC(N)=[NH2+])C1=O'}
helpers      = {'[C-]#[O+]', '[Br][Br]', 'C#N', 'N#N', 'O=NO', 'O=O', 'NO', 'S', 'N', 'C=O', 'Br', 'O', 'N#CO', 'O=S=O', 'O=[N+]([O-])O', 'C=C', 'O=C=O', 'CO', 'O=S(=O)(O)O', '[H][H]', 'O=S(O)O'}
target       = {'NC(=[NH2+])NCC=C1OC(=O)[C@@H](CC2(O)CO2)C1=O'}
maxAtoms     = {'C': 15, 'N': 5, 'O': 5, 'S': 1}
generations  = 2
ruleset      = "JN3604IMT"
searchDepth  = 2
maxNumRxns   = 2
