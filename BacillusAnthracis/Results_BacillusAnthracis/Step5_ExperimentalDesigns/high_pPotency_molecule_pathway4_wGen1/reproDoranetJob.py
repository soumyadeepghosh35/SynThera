...
jobName      = "high_pPotency_molecule_pathway4_wGen1"
starters     = {'C=CC[C@H]1CC(=CCNC(N)=[NH2+])OC1=O'}
helpers      = {'O=NO', 'S', 'O', 'Br', 'C=O', 'O=[N+]([O-])O', 'N', 'C=C', 'O=S=O', 'CO', '[C-]#[O+]', 'N#N', 'C#N', 'O=C=O', '[H][H]', 'O=O', 'O=S(=O)(O)O', 'O=S(O)O', 'N#CO', 'NO', '[Br][Br]'}
target       = {'C=CC1(C[C@H]2CC(=CCNC(N)=[NH2+])OC2=O)CO1'}
maxAtoms     = {'C': 15, 'N': 5, 'O': 3, 'S': 1}
generations  = 1
ruleset      = "JN3604IMT"
searchDepth  = 1
maxNumRxns   = 1
