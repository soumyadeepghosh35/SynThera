...
jobName      = "high_pPotency_molecule_pathway2_wGen2"
starters     = {'C=CCC1=CC(=CCNC(N)=[NH2+])OC1=O'}
helpers      = {'N', 'O=C=O', 'O=S=O', 'O=S(O)O', 'C#N', 'NO', 'N#CO', 'N#N', 'CO', 'Br', 'O=O', 'O=S(=O)(O)O', 'C=C', '[C-]#[O+]', 'O=NO', 'O', 'S', '[Br][Br]', 'O=[N+]([O-])O', 'C=O', '[H][H]'}
target       = {'CC(CNC(N)=[NH2+])=C1C=C(CCCO)C(=O)O1'}
