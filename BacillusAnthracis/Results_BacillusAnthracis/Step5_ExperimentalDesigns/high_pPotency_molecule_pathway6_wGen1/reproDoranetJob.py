...
jobName      = "high_pPotency_molecule_pathway6_wGen1"
starters     = {'C=CCC1=CC(=CCNC(N)=[NH2+])OC1=O'}
helpers      = {'O=NO', 'O=O', '[C-]#[O+]', 'O=S(O)O', 'C=C', 'N#N', 'O=[N+]([O-])O', 'O=C=O', 'C=O', 'S', 'Br', '[H][H]', 'O=S=O', '[Br][Br]', 'O', 'N#CO', 'NO', 'C#N', 'CO', 'N', 'O=S(=O)(O)O'}
target       = {'C=CC1(CC2=CC(=CCNC(N)=[NH2+])OC2=O)CO1'}
